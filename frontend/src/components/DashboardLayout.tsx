...
import { BarChart3, Settings, LogOut, ShieldAlert, Menu, X, Award, UserCircle2, Bell, UserPlus, LayoutDashboard, Users, Trophy, Megaphone, Activity, Lock, UserCircle, UserCheck } from 'lucide-react';
...
export const DashboardLayout = ({ children, isAdminView }: LayoutProps) => {
    ...
    const isInAdminView = isAdminView || location.pathname.startsWith('/admin');
        ...
        <div className="flex" style={{ minHeight: '100vh', overflow: 'hidden' }}>
            ...
            <AnimatePresence>
                {(!isMobile || isMobileMenuOpen) && (
                    ...
                    >
                        ...
                        {/* Show navigation menu for all views */}
                        ...
                        >
                            {/* Only show notifications for non-admin views */}
                            {!isInAdminView && (
            ...
            >
                <div className="container" style={{ 
                    maxWidth: isInAdminView ? '1400px' : '1100px', 
                    margin: '0 auto',
                    width: '100%'
                }}>
                    {children}
