                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: '3rem' }}>
                                ...
                                <motion.div variants={itemVariants} className="flex-col gap-5">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="reg-name" name="name" autoComplete="name" required className="input-field transition-all focus:scale-[1.02]" placeholder="John Doe" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} />
                                    </div>
                                    <div className="input-group">
                                        <label className="input-label text-[10px] uppercase font-bold tracking-[0.2em] opacity-50">Email</label>
                                        <input type="email" id="reg-email" name="email" autoComplete="email" required className="input-field transition-all focus:scale-[1.02]" placeholder="john@example.com" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} />
                                    </div>
                                    <div className="input-group">
                                        <label className="input-label text-[10px] uppercase font-bold tracking-[0.2em] opacity-50">College ID</label>
                                        <input type="text" id="reg-collegeId" name="username" autoComplete="username" required className="input-field transition-all focus:scale-[1.02]" placeholder="23CSE001" value={formData.collegeId} onChange={e => setFormData({ ...formData, collegeId: e.target.value })} />
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="input-group" style={{ flex: 1 }}>
                                            <label className="input-label text-[10px] uppercase font-bold tracking-[0.2em] opacity-50">Batch</label>
                                            <input type="text" id="reg-batch" name="batch" autoComplete="off" required className="input-field transition-all focus:scale-[1.02]" placeholder="2025" value={formData.batch} onChange={e => setFormData({ ...formData, batch: e.target.value })} />
                                        </div>
                                        <div className="input-group" style={{ flex: 1 }}>
                                            <label className="input-label text-[10px] uppercase font-bold tracking-[0.2em] opacity-50">Dept</label>
                                            <input type="text" id="reg-dept" name="department" autoComplete="off" required className="input-field transition-all focus:scale-[1.02]" placeholder="CSE" value={formData.department} onChange={e => setFormData({ ...formData, department: e.target.value })} />
                                        </div>
                                    </div>
                                    <div className="input-group">
                                        <label className="input-label text-[10px] uppercase font-bold tracking-[0.2em] opacity-50">Security Access</label>
                                        <input type="password" id="reg-password" name="new-password" autoComplete="new-password" required className="input-field transition-all focus:scale-[1.02]" placeholder="••••••••" value={formData.password} onChange={e => setFormData({ ...formData, password: e.target.value })} />
                                    </div>
                                </motion.div>
