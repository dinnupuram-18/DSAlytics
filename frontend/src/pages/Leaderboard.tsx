...
export default function Leaderboard() {
    ...
    useEffect(() => {
        ...
        const fetchLeaderboard = async (showLoading = true) => {
            ...
            try {
                ...
                if (activeTab === 'batch') {
                    ...
                    if (friendsRes.ok && selfRes.ok && isMounted) {
        ...
        // Delayed refetch 3 seconds later to pick up any silent auto-sync update
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 min-w-0">
                                        ...
                                        <div className="truncate flex-1">
                                            ...
                                            <div className="flex gap-2 mt-2 flex-wrap" style={{ gap: '6px' }}>
                                                <span style={{ fontSize: '9px', fontWeight: 800, padding: '2px 6px', borderRadius: '6px', background: 'rgba(251,146,60,0.1)', color: '#fb923c', border: '1px solid rgba(251,146,60,0.2)', whiteSpace: 'nowrap' }}>
                                                    LC: {student.leetcodePoints || 0}
                                                </span>
                                                {(student.codechefPoints > 0 || student.codechefUrl) && (
                                                    <span style={{ fontSize: '9px', fontWeight: 800, padding: '2px 6px', borderRadius: '6px', background: 'rgba(148,163,184,0.1)', color: '#94a3b8', border: '1px solid rgba(148,163,184,0.2)', whiteSpace: 'nowrap' }}>
                                                        CC: {student.codechefPoints || 0}
                                                    </span>
                                                )}
                                                {(student.codeforcesPoints > 0 || student.codeforcesUrl) && (
                                                    <span style={{ fontSize: '9px', fontWeight: 800, padding: '2px 6px', borderRadius: '6px', background: 'rgba(99,102,241,0.1)', color: '#6366f1', border: '1px solid rgba(99,102,241,0.2)', whiteSpace: 'nowrap' }}>
                                                        CF: {student.codeforcesPoints || 0}
                                                    </span>
                                                )}
                                                {(student.gfgPoints > 0 || student.gfgUrl) && (
                                                    <span style={{ fontSize: '9px', fontWeight: 800, padding: '2px 6px', borderRadius: '6px', background: 'rgba(34,197,94,0.1)', color: '#22c55e', border: '1px solid rgba(34,197,94,0.2)', whiteSpace: 'nowrap' }}>
                                                        GFG: {student.gfgPoints || 0}
                                                    </span>
                                                )}
                                                {(student.hackerrankPoints > 0 || student.hackerrankUrl) && (
                                                    <span style={{ fontSize: '9px', fontWeight: 800, padding: '2px 6px', borderRadius: '6px', background: 'rgba(27,169,76,0.1)', color: '#1ba94c', border: '1px solid rgba(27,169,76,0.2)', whiteSpace: 'nowrap' }}>
                                                        HR: {student.hackerrankPoints || 0}
                                                    </span>
                                                )}
                                            </div>
                                        </div>
